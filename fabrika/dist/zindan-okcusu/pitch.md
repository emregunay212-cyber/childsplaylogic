...
Roguelite archer arena: auto-aim waves of quirky monsters, pick 1-of-3 upgrades each level, earn gold, unlock/merge/upgrade equipment, beat chapter bosses. Persistent meta-progression (gear + talent tree) plus an Endless mode.

**Gerçek bir okulda, sınıf ortamında öğrencilerle test edilmiştir** (geliştirici öğretmendir, 80+ öğrenci).
...
## Notlar
- Kayıt sistemi portal SDK storage'a bağlanır; SDK yoksa oturum-içi bellekte çalışır.
- İçerik: 10+ düşman türü, 3 boss, yetenek ağacı, ekipman birleştirme, Kabus zorluğu.
