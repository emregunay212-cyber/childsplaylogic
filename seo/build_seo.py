...
GAMES = [
  ...
  dict(slug="bilgi-ziplamasi", name="Bilgi Zıplaması", cat="Karma / Platform", age="7-12", players="Tek kişilik",
       teaches="Tüm dersler + refleks ve denge",
       short="Sonsuz zıplama: her 10 platformda soru — doğruya in, yaylanıp uzaya fırla!",
       about="Bilgi Zıplaması'nda karakterin kendiliğinden zıplar; sen sağa-sola yönlendirirsin. Her 10 platformda bir SORU katmanı gelir: üç cevap platformu yan yana dizilir, doğru cevabın platformuna inersen yaylanıp fırlarsın — yanlış platform kırılır! Skor yüksekliğinle büyür: 500 metrede orman, 1500'de bulutlar, 3000'de UZAY! Dağ temalı portalın ruhuna en uygun oyun: Etek'ten Zirve'ye gerçekten tırmanıyorsun. Ücretsiz, üyeliksiz."),
