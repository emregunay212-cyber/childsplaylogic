...
GAMES = [
  ...
  dict(slug="klavye-kasifi", name="Klavye Kâşifi", cat="Okul Öncesi", age="4-6", players="Tek kişilik",
       teaches="Klavye tanıma: harfi tuşta bulma, tek basış, sıra ve Boşluk tuşu",
       short="Yanan tuşu bul, harfe bas, resmi kazan — klavyeye ilk adım.",
       about="Klavye Kâşifi, anaokulu çocuğunun klavyeyi tanıdığı ilk oyundur: ekrandaki büyük harfi Türkçe Q klavyede bulur, tek parmakla basar ve gizli resmi kazanır. Birinci seviyede aranan tuş yanar, ikincisinde çocuk tuşu kendisi hatırlar, üçüncüsünde kısa kelimeleri harf harf yazıp Boşluk tuşunu öğrenir. Fiziksel klavyeyle ya da ekrandaki klavyeye dokunarak oynanır; süre ve can baskısı yoktur. 4-6 yaş için ücretsiz."),
