...
- [x] Kabul geçidi: reality-checker ✓ · güvenlik denetçisi ✓ · /code-review ✓ · evidence-collector ✓ (bulgular kapatıldı) — bkz. §9
...
| **Evidence Collector** | NEEDS WORK (1 yüksek, 3 orta, 2 düşük) → hepsi ele alındı, kanıt yeniden alındı | Yüksek: telefonda ipucu metni hiç görünmüyordu → dar görünümde ipucu tostu. Orta: çekilen top köşede kırpılıyor, bant %57'de doyuyordu → fırlatma noktası (150,360) + ışın boyunca kırpma, 30 çözüm yeniden tarandı; hayalet yay tost altında/soluk → tost üst bant, beyaz altlıklı yay, nişanda tost kapanır; hub günlük giriş tostu oyunu örtüyor → kabuk işi, ayrı görev açıldı. Düşük: 4 kanıt görüntüsü iddiayı göstermiyordu → betik düzeltildi, 18 görüntü yeniden; dikey telefonda HUD 90° dönük → kabul edilen risk (Eğim kalıbı), 12 px. |
