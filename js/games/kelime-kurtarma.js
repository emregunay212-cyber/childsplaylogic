/* OYUN: Kelime Kurtarma — balon asmaca, yumuşatılmış tema (Faz 4 / 4.12)
   Eğitsel seri — bağımsız tek-dosya HTML oyunu (games/kelime-kurtarma/index.html),
   iframe ile gömülür; kayıt window.storage → localStorage + gameSaves senkronu.
   Yıldız vermez (eğitsel seri kilitsiz). */

const KelimeKurtarma = (() => {
    const id = 'kelime-kurtarma';
    const levels = [{}];
    ...
    function init(gameArea, level, callbacks) {
        ...
        iframe.src = 'games/kelime-kurtarma/index.html?v=1';
        iframe.className = 'kk-iframe';
