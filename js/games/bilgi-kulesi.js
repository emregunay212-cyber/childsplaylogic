/* OYUN: Bilgi Kulesi — 12 katlı soru merdiveni (Faz 5 / 4.18)
   Eğitsel seri — bağımsız tek-dosya HTML oyunu (games/bilgi-kulesi/index.html),
   iframe ile gömülür; kayıt window.storage → localStorage + gameSaves senkronu.
   Yıldız vermez (eğitsel seri kilitsiz). */

const BilgiKulesi = (() => {
    const id = 'bilgi-kulesi';
    const levels = [{}];
    ...
    function init(gameArea, level, callbacks) {
        ...
        iframe.src = 'games/bilgi-kulesi/index.html?v=1';
        iframe.className = 'bk2-iframe';
