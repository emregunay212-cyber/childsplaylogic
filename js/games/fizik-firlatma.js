/* OYUN: Fizik Fırlatma — sayısal açı/kuvvet sapanı, 12 bölüm (Faz 6 / 4.20)
   Eğitsel seri — bağımsız tek-dosya HTML oyunu (games/fizik-firlatma/index.html),
   iframe ile gömülür; kayıt window.storage → localStorage + gameSaves senkronu.
   Yıldız vermez (eğitsel seri kilitsiz). */

const FizikFirlatma = (() => {
    const id = 'fizik-firlatma';
    const levels = [{}];
    ...
    function init(gameArea, level, callbacks) {
        ...
        iframe.src = 'games/fizik-firlatma/index.html?v=1';
        iframe.className = 'ff-iframe';
