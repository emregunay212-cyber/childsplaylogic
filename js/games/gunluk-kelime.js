/* OYUN: Günlük Kelime — okul geneli aynı Wordle (Faz 5 / 4.15)
   Eğitsel seri — bağımsız tek-dosya HTML oyunu (games/gunluk-kelime/index.html),
   iframe ile gömülür; kayıt window.storage → localStorage + gameSaves senkronu.
   Yıldız vermez (eğitsel seri kilitsiz). */

const GunlukKelime = (() => {
    const id = 'gunluk-kelime';
    const levels = [{}];
    ...
    function init(gameArea, level, callbacks) {
        ...
        iframe.src = 'games/gunluk-kelime/index.html?v=1';
        iframe.className = 'gk-iframe';
