...
`GLTFLoader.r128.js` → `data/games.json` `lego-world` (`three.min.js` r128 hâlâ cdnjs'ten, B6'da `js/lib/three.r128.min.js`
olarak tekilleşecek), `THREE.GLTFLoader`; `stockfish.js` → `js/games/satranc-engine.js` (Blob Worker).
