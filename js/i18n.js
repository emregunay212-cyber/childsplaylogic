...
const TR = {
    ...
    // Oyun adları: data/games.json → js/catalog.js (GAME_CATALOG; ÜRETİLMİŞ, npm run catalog).
    // Ad değişikliği JSON'a yapılır; bu nesnenin arayüzü aynı (TR.games[slug] → ad).
    games: GAME_CATALOG.reduce((names, g) => { names[g.slug] = g.name; return names; }, {}),
    ...
    instructions: {
        ...
        'matematik': 'Topla ve çıkar!',
        'hece-birlestirme': 'Heceleri birleştir!',
        'jigsaw': 'Parçaları birleştir!',
        'desen': 'Deseni tamamla!',
        'lego-macerasi': 'Parça topla, inşa et!',
        'lego-world': '3D dünyayı keşfet!',
        ...
        'son-kart': 'Renk ve sayıları eşleştir, elini ilk bitiren kazanır! Bota karşı ya da 2-4 kişi online.',
